...
follow1 = FollowAssignment.create({user_id: 3, game_id: 1})
follow2 = FollowAssignment.create({user_id: 2, game_id: 4})
follow3 = FollowAssignment.create({user_id: 1, game_id: 2})
follow4 = FollowAssignment.create({user_id: 1, game_id: 3})
